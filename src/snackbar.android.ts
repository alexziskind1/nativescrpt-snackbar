...
import { CoolThing } from 'docoolthing';
...
export class SnackBar {
  ...
  private _coolThing = new CoolThing();
  ...
  public simple(
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        // https://github.com/bradmartin/nativescrpt-snackbar/issues/33
        if (maxLines) {
        ...
        // https://github.com/bradmartin/nativescrpt-snackbar/issues/26
        if (isRTL === true) {
          const sbView = this._snackbar.getView();
